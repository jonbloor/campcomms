...
export type EventDetails = {
  ...
  unread_counts: { discussions: number; lost_found: number; lifts: number; private_messages: number };
  announcements: Array<{ id: string; title: string; body: string; importance: string; acknowledgement_required: number; acknowledged: number; acknowledgement_count: number; author_name: string; author_parent_of: string; author_role: string; published_at: string }>;
